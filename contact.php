...
<head>
    ...
    <title>Smart Parking System - Contact</title>
    ...
    <div class="contact-container">
        <div class="contact-wrapper">
            <div class="contact-form-section">
                ...
                <form method="POST" action="contact.php">
                    <div class="input-group">
                        ...
                        <input type="text" name="name" value="<?= htmlspecialchars($user['fullname']) ?>" required>
                    </div>
            ...
            <div class="contact-info-section">
                ...
                <div class="info-card">
                    <div class="info-icon"><img src="location-pin.png" width="50"></div>
                    <h3>Address</h3>
                    <p>123 Parking Street<br>Downtown City, ST 12345</p>
                </div>
                
                <div class="info-card">
                    <div class="info-icon"><img src="telephone.png" width="50"></div>
                    <h3>Phone</h3>
                    <p>+1 (555) 123-4567<br>+1 (555) 987-6543</p>
                </div>
                
                <div class="info-card">
                    <div class="info-icon"><img src="google.png" width="60"></div>
                    <h3>Email</h3>
                    <p>info@smartparking.com<br>support@smartparking.com</p>
                </div>
                
                <div class="info-card">
                    <div class="info-icon"><img src="timetable.png" width="40"></div>
